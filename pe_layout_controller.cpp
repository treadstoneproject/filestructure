...
virtual std::map<uint64_t, IMAGE_NT_HEADERS>&
pe_layout_controller<MappedFileLayout>::
get_header(std::vector<MappedFileType *> *mapped_ftype_ptr_vec)
{
...
pe_layout_controller<MappedFileLayout>::
get_offset(MappedFileType *map_ftype_ptr,
...
template<typename MappedFileLayout>
bool pe_layout_controller<MappedFileLayout>::
...
//Why compile pass.
template class pe_layout_controller<struct MAPPED_FILE_PE>;
