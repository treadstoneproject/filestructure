...
LIBOBJS = 
LIBS = -lmongoclient -lgtest -lglog -lOpenCL -lrt -lclamav -lprotobuf -ldl -lfolly -lrocksdb  -lcrypto -ltracethreat_client-0.0.1 -lboost_filesystem-mt -lboost_thread-mt -lpthread -lboost_system-mt -lboost_log-mt -lboost_exception-mt -lboost_program_options-mt -lboost_timer-mt 
LTLIBOBJS = 
